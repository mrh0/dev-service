...
exports.get = exports.del = exports.set = void 0;
var logging_1 = require("../util/logging");
function error(msg) {
    logging_1.err("DB", msg);
    return msg;
}
var database = {};
function set(_a, fail) {
...
exports.del = del;
function get(_a, fail) {
    var key = _a.key, all = _a.all;
    if (fail === void 0) { fail = false; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            if (fail)
...
exports.get = get;
exports.default = { set: set, del: del, get: get };
