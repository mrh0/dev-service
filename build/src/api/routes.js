...
app.post("/commit", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logging_1.default("POST", "commit", "begin");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.set(req.body)];
            case 2:
                _a.sent();
                res.json({ accepted: true });
                return [3 /*break*/, 4];
...
app.delete("/commit", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logging_1.default("DELETE", "commit", "begin");
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.del(req.body)];
            case 2:
                _a.sent();
                res.json({ accepted: true });
                return [3 /*break*/, 4];
...
app.get("/commit", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                logging_1.default("GET", "commit", "begin");
                _d.label = 1;
            case 1:
                _d.trys.push([1, 3, , 4]);
                _b = (_a = res).json;
                _c = { accepted: true };
                return [4 /*yield*/, db_1.default.get(req.body)];
            case 2:
